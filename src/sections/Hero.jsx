...
const Hero = () => {
  ...
  return (
    <section
      id='home'
      className="w-full flex  xl:flex-row flex-col min-h-screen gap-10 
      max-container"
    >
      ...
      items-start w-full max-xl:padding-x pt-28'>
        ...
        <p className='font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm'> Discover stylish Nike arrivals, quality comfort, and innvoation for your active life.</p>
        ...
        <div className='flex justify-start items-start flex-wrap w-full mt-20 gap-16'>
          {statistics.map((stat, idx) => (
            <div key = {idx}> 
              ...
              <p className='text-slate-gray font-montserrat leadin-7'>{stat.label}</p>
            </div>
          ))}
